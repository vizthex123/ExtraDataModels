...
2) Download [the mod](https://www.curseforge.com/minecraft/mc-mods/open-loader), and in the instance for the modpack download the datapack (you can just search for `vizthex` to quickly find it, or copy & paste the project ID off of the CF page)
