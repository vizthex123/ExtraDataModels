...
*Archived on 2025-12-15 because I changed all the version numbers to follow modding standards (so the 1.18 port is v1.X, the 1.19 port is v2.X, etc.)*
...
Fixed the pack format being wrong (I don't think it affects anything, but it bothers me if it's wrong)<br />
...
Fixed the pack format being wrong<br />
Removed Totem loot from the Illusioner and Iceologer (since neither Totem is in this version) *[Friends & Foes]*
